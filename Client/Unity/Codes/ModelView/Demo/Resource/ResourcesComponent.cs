...
namespace ET
{
    ...
    public class ResourcesComponent: Entity, IAwake
    {
        ...
        public void SetReloginMaskShow()
        {
            if (Init.Global == null)
                return;
            GameObject maskObj = Refer(Init.Global,"ReloginMask");
            if (maskObj == null)
            {
                Debug.Log("maskObj == null");
            }

            maskObj?.SetActive(true);
        }
        
        public  GameObject Refer(GameObject obj, string name)
        {
        ...
        public async ETTask UnLoadAllBundle()
        {
            foreach (string str in BundleNameToLowerDict.Values)
            {
        ...
        /// </summary>
        public async ETTask LoadBundleAsync(string assetBundleName,Action callBack = null)
        {
            assetBundleName = assetBundleName.BundleNameToLower();
